...
export const sampleMissions: Mission[] = [
  { id: 'm-dark-tc', title: 'Dark Age TC Rhythm', description: 'Keep villagers queued until Feudal is clicked.', passCriteria: 'Idle TC stays under 25 seconds before Feudal.', successMetric: 'Pass in 3 of your next 5 games.', targetCount: 3, xp: 120, category: 'Macro', completed: false },
  { id: 'm-houses', title: 'Avoid Getting Housed', description: 'Place houses before the warning becomes a crisis.', passCriteria: 'No house block before 12:00.', successMetric: 'Pass in 3 of your next 5 games.', targetCount: 3, xp: 90, category: 'Dark Age', completed: false },
  { id: 'm-scout', title: 'Scout With a Question', description: 'Use the scout to answer what the opponent is building, not just to reveal the map.', passCriteria: 'Confirm the first enemy military building by 8:30.', successMetric: 'Pass in 2 of your next 3 games.', targetCount: 2, xp: 110, category: 'Scouting', completed: false },
  { id: 'm-castle-plan', title: 'Spend the First Castle Minute', description: 'Arrive in Castle Age with a plan: boom, pressure, defend, or tech switch.', passCriteria: 'Choose and start your Castle plan within 60 seconds of aging up.', successMetric: 'Pass twice before moving to harder Castle missions.', targetCount: 2, xp: 140, category: 'Castle Age', completed: false },
  { id: 'm-fight-vills', title: 'Fight Without Forgetting Eco', description: 'Use control groups and hotkeys so battles do not stop villager production.', passCriteria: 'No TC idle spike during the first two major fights.', successMetric: 'Pass in 3 of your next 5 games.', targetCount: 3, xp: 130, category: 'Macro', completed: false },
  { id: 'm-replay-moment', title: 'Review One Turning Point', description: 'After a loss, identify the exact minute where the game became harder to control.', passCriteria: 'Log one replay review with cause, category, and next-game mission.', successMetric: 'Review 2 losses before adding a new advanced mission.', targetCount: 2, xp: 100, category: 'Replay', completed: false },
];
